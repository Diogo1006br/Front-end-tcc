...
export default function Users() {
  ...
  const [userPostData, setUserPostData] = useState<FormData>({
    email: "",
    company: "",
    firstName: "",
    lastName: "",
  ...
  const handleDateChange = (e) => {
    ...
    if (validateDate(value)) {
      ...
      setErrorMessage('Formato inválido para data. Use um dos formatos a seguir: YYYY-MM-DD.');
    }
  };
          ...
          <div className="grid grid-cols-4 grid-rows-4 gap-4">
            ...
            <div className="row-span-1 mt-10">
              ...
              <div className="grid w-full max-w-sm items-center gap-1.5 mt-4">
                ...
                <Input
                  ...
                  placeholder=""
                  value={user.CPF}
                  maxLength={14} // Limita a entrada a 14 caracteres (incluindo pontos e hífen)
                  onChange={(e) => {
            ...
            <div className="row-span-1 mt-10">
              <div className="grid w-full max-w-sm items-center gap-1.5">
                ...
                <Input type="string" id="sobrenoome" placeholder="" value={user.lastName} onChange={(e) => {
                    const newValue = e.target.value;
              ...
              <div className="grid w-full max-w-sm items-center gap-1.5 mt-4">
                ...
                <Input type="number" id="telefone" placeholder="" value={user.phone} onChange={(e) => {
                    const newValue = e.target.value;
            ...
            <div className="row-span-1 mt-10">
              <div className="grid w-full max-w-sm items-center gap-1.5">
                ...
                <Input type="string" id="cargo" placeholder="" value={user.companyPosition} onChange={(e) => {
                    const newValue = e.target.value;
            ...
            <div className="col-start-2 row-start-3 space-y-4">
              ...
              <Label className="font-bold" htmlFor="cargo">Email</Label>
                <Input type="string" id="cargo" placeholder="" value={user.email} onChange={(e) => {
                    const newValue = e.target.value;
